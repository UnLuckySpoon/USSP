...
ent-FoodSnackAChocolate = шоколад "Алёнка"
    .desc = Шоколад "Алёнка" фирмы "Космо-Октябрь".
ent-FoodSnackAChocolateBar = шоколад "Алёнка"
    .desc = Шоколад "Алёнка" фирмы "Космо-Октябрь".
ent-FoodPacketAChocolateTrash = обёртка шоколада "Алёнка"
    .desc = Кажется,девушка на обёртке старше,чем её предшественница.