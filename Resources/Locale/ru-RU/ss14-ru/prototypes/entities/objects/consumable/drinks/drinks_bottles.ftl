...
ent-DrinkBuratinoBottleFull = бутылка "Буратино"
    .desc = Бутылка "Буратино". Вкусный лимонад!
ent-DrinkKvasBottleFull = бутылка кваса
    .desc = Бутылка вкусного,освежающего ржаного кваса,товариши!